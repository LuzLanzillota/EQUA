        ...
        <div className="todo">
            ...
            <div className="formas">
                <div className="forma1">
                    <img src="/images/formas/forma1-inicio.png" alt="Imagen de Motion graphics" />
                    <h2>Motion graphics</h2>
                    <p>Crea magia SVG, transforma, anima y mucho más.</p>
                </div>
                <div className="forma1">
                    <img src="/images/formas/forma2-inicio.png" alt="Imagen de Modelado 3D" />
                    <h2>Modelado 3D</h2>
                    <p>Vuelve realidad tus personajes, objetos, escenarios y más.</p>
                </div>
                <div className="forma1">
                    <img src="/images/formas/forma3-inicio.png" alt="Imagen de Diseño web" />
                    <h2>Diseño web</h2>
                    <p>Te ayudamos con tu diseño; y si ya lo tenés, lo hacemos funcionar.</p>
                </div>
                <div className="forma1">
                    <img src="/images/formas/forma4-inicio.png" alt="Imagen de Branding" />
                    <h2>Branding</h2>
